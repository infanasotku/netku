...
from app.adapters.output.grpc.gen import xray_pb2 as app_dot_adapters_dot_output_dot_grpc_dot_gen_dot_xray__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in app/adapters/output/grpc/gen/xray_pb2_grpc.py depends on'
