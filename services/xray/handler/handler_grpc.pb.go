...
const (
	HandlerService_RestartXray_FullMethodName = "/handler.HandlerService/RestartXray"
)
...
func (c *handlerServiceClient) RestartXray(ctx context.Context, in *Null, opts ...grpc.CallOption) (*RestartResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RestartResponse)
	err := c.cc.Invoke(ctx, HandlerService_RestartXray_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHandlerServiceServer) RestartXray(context.Context, *Null) (*RestartResponse, error) {
...
func _HandlerService_RestartXray_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Null)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HandlerServiceServer).RestartXray(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HandlerService_RestartXray_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HandlerServiceServer).RestartXray(ctx, req.(*Null))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _HandlerService_RestartXray_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "protobuf/handler.proto",
}
